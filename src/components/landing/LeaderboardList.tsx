...
export function LeaderboardList({
  ...
  return <div className="divide-y h-full">
      {entries.map(entry => <div key={`${entry.username}-${entry.rank}`} className="flex items-center p-4 hover:bg-muted/30 transition-colors">
          ...
          <div className="flex items-center space-x-3">
            ...
            {entry.chart_link && <a href={entry.chart_link} target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors">
