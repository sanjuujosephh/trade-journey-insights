  ...
  return <>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="space-y-2">
          ...
          <Input id="strike_price" name="strike_price" type="number" step="0.01" placeholder="0.00" value={formData.strike_price} onChange={handleChange} />
          <div className="text-xs text-muted-foreground">Option price exercised</div>
        </div>
        <div className="space-y-2">
          <Label htmlFor="quantity">Quantity</Label>
          <Input id="quantity" name="quantity" type="number" step="1" placeholder="0" value={formData.quantity} onChange={handleChange} />
          <div className="text-xs text-muted-foreground">Number of contracts traded</div>
        </div>
        <div className="space-y-2">
          <Label htmlFor="option_type">Option Type</Label>
          <Select name="option_type" value={formData.option_type} onValueChange={value => handleSelectChange("option_type", value)}>
            <SelectTrigger>
          ...
          <div className="text-xs text-muted-foreground">Call or Put</div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="space-y-2">
          ...
          <Input id="call_iv" name="call_iv" type="number" step="0.01" placeholder="0.00" value={formData.call_iv} onChange={handleChange} />
          <div className="text-xs text-muted-foreground">Implied volatility for call option</div>
        </div>
        <div className="space-y-2">
