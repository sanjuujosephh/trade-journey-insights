...
export function BehavioralMetrics({ formData, handleChange, handleSelectChange }: BehavioralMetricsProps) {
  ...
  return (
    <div className="space-y-4 pt-2">
      <h3 className="text-sm font-medium">Trading Psychology</h3>
      
      <div className="flex items-center justify-between">
        <Label htmlFor="is_impulsive" className="text-sm">Was this an impulse trade?</Label>
        <Switch
          id="is_impulsive"
          checked={formData.is_impulsive}
          onCheckedChange={(checked) => handleSelectChange("is_impulsive", checked)}
        />
      </div>
      ...
      <div className="flex items-center justify-between">
        ...
        <Switch
          id="plan_deviation"
          checked={formData.plan_deviation}
          onCheckedChange={(checked) => handleSelectChange("plan_deviation", checked)}
        />
      </div>
      ...
      <div className="space-y-2">
        ...
        <Slider
          ...
          onValueChange={handleSatisfactionScoreChange}
        />
        <div className="flex justify-between text-xs text-muted-foreground">
          <span>Poor</span>
          <span>Average</span>
      ...
      <div className="space-y-2">
        ...
        <Select
          ...
          onValueChange={(value) => handleSelectChange("time_pressure", value)}
        >
